...
insert into Member values(2,'Ankhith','2000-01-07',9,100)
insert into Member values(3,'Harshuith','2005-01-14',7,101)
insert into Member values(4,'Divya Priyanka','2000-04-17',3,108)
insert into Member values(5,'Chinna Naidu','2000-03-13',2,500)
insert into Member values(6,'SriRam','2000-04-19',5,50)
insert into Member values(7,'Gopal,CURRENT_TIMESTAMP,3,null)

alter table Member 
alter column Member_Name Char(20)


insert into Member values(5,'Dora','2000-03-13',110,500)
use Library
...
insert into Issue values(801,101,1,'10-Dec-06','')
insert into Issue values(802,102,2,'25-Dec-06','')
insert into Issue values(803,104,1,'15-Jan-06','')
insert into Issue values(804,101,1,'04-Jul-06','')
insert into Issue values(805,104,2,'15-Nov-06','')
insert into Issue values(806,101,3,'18-Feb-06','')


insert into Issue values(807,103,3,'12-Oct-06','')
insert into Issue values(808,102,1,'28-Mar-06','')
